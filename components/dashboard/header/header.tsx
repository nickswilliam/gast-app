...
export const DashboardHeader = () => {
  ...
  return (
    <header className="transition-all ease-out sticky w-full top-0 flex h-[54px] items-center justify-between p-4 bg-slate-100 shadow-md border-b rounded-r-lg">
      <Link href="/dashboard">
